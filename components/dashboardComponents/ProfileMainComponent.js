...
const ProfileMainComponent = () => {
  ...
  if (user) {
    return (
      <div className="h-auto sm:min-h-[100dvh] p-4">
        <h1 className="text-2xl hidden sm:block">Profile</h1>
        <div className="sm:hidden flex gap-4 items-center text-lg bg-blueDark text-white rounded-3xl p-4">
          <Link href={"/"}>
            <ArrowButton />{" "}
          </Link>{" "}
          <h1>Profile</h1>
